...
namespace Reportman.Drawing
{
    public class PrintOutText : PrintOut, IDisposable
    {
        ...
        private void UpdatePrinterConfig()
        {
            ...
            allowedsteps.Add(PrintStepType.cpi5, PrintStepType.cpi10);
            allowedsteps.Add(PrintStepType.cpi6, PrintStepType.cpi10);
            allowedsteps.Add(PrintStepType.cpi10, PrintStepType.cpi10);
            allowedsteps.Add(PrintStepType.cpi12, PrintStepType.cpi10);
            allowedsteps.Add(PrintStepType.cpi15, PrintStepType.cpi10);
            allowedsteps.Add(PrintStepType.cpi17, PrintStepType.cpi10);
            allowedsteps.Add(PrintStepType.cpi20, PrintStepType.cpi10);
