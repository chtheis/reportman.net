...
namespace Reportman.Commands
{
    ...
    public class PrintReport
    {
        static private Strings GetParams()
        {
            ...
            aresult.Add("-preview Show preview window");
            aresult.Add("-showparams Show parameters window window");
            ...
            aresult.Add("-m metafilename Output to report metafile");
            aresult.Add("-deletereport Delete the report file after completion");
            aresult.Add("-systempreview Show System preview instead Report Manager preview");
            aresult.Add("-u Save pdf/metafile as uncompressed");
            aresult.Add("-eval exp Evaluate expression and show result");
            aresult.Add("-syntax exp Syntax check expression");
            aresult.Add("-printdialog Show print dialog before printing");
            aresult.Add("-printername Use the printer device");
            aresult.Add("-getprinters List available printers");
            aresult.Add("-paramPARAMNAME=Value Assigns a value to aparameter");
        ...
        /// <description>Show preview window, that is output to screen</description>
        /// </item>
