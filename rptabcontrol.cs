...
namespace Reportman.Drawing.Forms
{
   ...
   public partial class TabControlAdvanced : UserControl
   {
...
//      }
        ...
        public TabControlAdvanced()
        {
           ...
           InitializeComponent();
            ...
            _leftArrow.Size = _rightArrow.Size = _closeButton.Size = _dropDownButton.Size = new Size(_buttonWidth, _buttonHeight);
        ...
        protected virtual int GetTabPageSpace(Graphics g, TabPageAdvanced page)
        {
            ...
            // Any text provided?
            if ((page.Title.Length > 0) || (_showCloseIndividual))
            {
        ...
        protected virtual void DrawTab(TabPageAdvanced page, Graphics g, bool highlightText)
        {
                ...
                if (xDraw < xMax)
                {
                    ...
                    if (xDraw < xMax)
                    {
                       if (_showCloseIndividual)
                        ...
                        if ((_showCloseIndividual) && (page.Selected || highlightText))
                        {
                           g.DrawImage(_internalImages.Images[4], new Point(xMax + _buttonGap, yStart + (yEnd - yStart - _internalImages.Images[4].Height) / 2));
                           if (highlightText)
                           {
                              g.DrawRectangle(Pens.Black, new Rectangle(xMax + _buttonGap, yStart + (yEnd - yStart - _buttonHeight) / 2, _internalImages.Images[4].Width, _internalImages.Images[4].Height));
                           }
                        }
                    }
