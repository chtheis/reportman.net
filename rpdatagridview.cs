...
namespace Reportman.Drawing.Forms
{
	...
	public class DataGridViewAdvanced:DataGridView
	{
        ...
        public DataGridViewAdvanced()
        {
            ...
            onlygridkeys.Add(Keys.F1,Keys.F1);
            onlygridkeys.Add(Keys.F2, Keys.F2);
            onlygridkeys.Add(Keys.F3, Keys.F3);
            onlygridkeys.Add(Keys.F4, Keys.F4);
            onlygridkeys.Add(Keys.F5, Keys.F5);
            onlygridkeys.Add(Keys.F6, Keys.F6);
            onlygridkeys.Add(Keys.F7, Keys.F7);
            onlygridkeys.Add(Keys.F8, Keys.F8);
            onlygridkeys.Add(Keys.F9, Keys.F9);
            onlygridkeys.Add(Keys.F10, Keys.F10);
            onlygridkeys.Add(Keys.F11, Keys.F11);
            onlygridkeys.Add(Keys.F12, Keys.F12);
            onlygridkeys.Add(Keys.PageDown, Keys.PageDown);
            onlygridkeys.Add(Keys.PageUp, Keys.PageUp);
        }
...
//                                FinishEdit();
        ...
        private void OpenImageClic(object sender, EventArgs args)
        {
            ...
            ndialog.Filter = Translator.TranslateStr(706) + "|*.bmp|" +
                Translator.TranslateStr(880) + "|*.jpg;*.jpeg|" +
                "Imagen Gif" + "|*.gif|Imagen Png|*.png";
        ...
        private void gridav_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void gridav_KeyPress(object sender, KeyPressEventArgs args)
        {
//            OnKeyPress(args);
        }
                ...
                foreach (string line in lines)
                {
                    if (line.Length > 0)
                    {
                        ...
                        if (nvrow.DataBoundItem == null)
                        {
                            //nrow = ntable.NewRow();
                            this.BindingContext[this.DataSource].CancelCurrentEdit();
                            this.BindingContext[this.DataSource].AddNew();
                            nrow = ((DataRowView)this.BindingContext[this.DataSource].Current).Row;
                            added = true;
                        }
                        else
        ...
        protected override void OnEditingControlShowing(DataGridViewEditingControlShowingEventArgs e)
        {
            ...
            if (index < 0)
            {
                e.Control.KeyDown += new KeyEventHandler(gridav_KeyDown);
                e.Control.KeyPress += new KeyPressEventHandler(gridav_KeyPress);
                taggedcontrols++;
    ...
    public class ScrollTextPanel : Panel
    {
        ...
        public ScrollTextPanel()
        {
            ...
            ntimer.Interval = 33;
            ntimer.Tick += new EventHandler(ntimer_Tick);
        }

        void ntimer_Tick(object sender, EventArgs e)
        {
