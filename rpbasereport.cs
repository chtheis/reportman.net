...
namespace Reportman.Reporting
{
    ...
    private void ReleaseMetafile()
    {
      ...
      FMetaFile.OnRelease += new MetaStopWork(ReleaseMetafile);
			...
			EvalIdens.Add("PAGE", new IdenReportVar(Evaluator, this, "PAGE"));
			EvalIdens.Add("PAGINA", new IdenReportVar(Evaluator, this, "PAGE"));
			EvalIdens.Add("LANGUAGE", new IdenReportVar(Evaluator, this, "LANGUAGE"));
			EvalIdens.Add("PAGENUM", new IdenReportVar(Evaluator, this, "PAGENUM"));
			EvalIdens.Add("PAGEWIDTH", new IdenReportVar(Evaluator, this, "PAGEWIDTH"));
			EvalIdens.Add("PAGEHEIGHT", new IdenReportVar(Evaluator, this, "PAGEHEIGHT"));
			EvalIdens.Add("FREE_SPACE_CMS", new IdenReportVar(Evaluator, this, "FREE_SPACE_CMS"));
			EvalIdens.Add("FREE_SPACE_INCH", new IdenReportVar(Evaluator, this, "FREE_SPACE_INCH"));
			EvalIdens.Add("FREE_SPACE_TWIPS", new IdenReportVar(Evaluator, this, "FREE_SPACE_TWIPS"));
			EvalIdens.Add("CURRENTGROUP", new IdenReportVar(Evaluator, this, "CURRENTGROUP"));
            EvalIdens.Add("CURRENTPOSX", new IdenReportVar(Evaluator, this, "CURRENTPOSX"));
            EvalIdens.Add("CURRENTPOSY", new IdenReportVar(Evaluator, this, "CURRENTPOSY"));
            EvalIdens.Add("FIRSTSECTION", new IdenReportVar(Evaluator, this, "FIRSTSECTION"));
			EvalIdens.Add("EOF", new IdenEof(Evaluator, this));
			EvalIdens.Add("SETLANGUAGE", new IdenSetLanguage(Evaluator, this));
			EvalIdens.Add("REOPEN", new IdenReOpen(Evaluator, this));
			EvalIdens.Add("GRAPHICOP", new IdenGraphicOp(Evaluator, this));
			EvalIdens.Add("IMAGEOP", new IdenImageOp(Evaluator, this));
			EvalIdens.Add("BARCODEOP", new IdenBarcodeOp(Evaluator, this));
			EvalIdens.Add("TEXTOP", new IdenTextOp(Evaluator, this));
			EvalIdens.Add("TEXTHEIGHT", new IdenTextHeight(Evaluator, this));
			EvalIdens.Add("PARAMINFO", new IdenParamInfo(Evaluator, this));
			EvalIdens.Add("SETPAGESOURCE", new IdenPageOp(Evaluator, this));
			EvalIdens.Add("SETPAGEORIENTATION", new IdenOrientationOp(Evaluator, this));
			EvalIdens.Add("GETVALUEFROMSQL", new IdenGetValueFromSQL(Evaluator, this));
            EvalIdens.Add("GRAPHICNEW", new IdenGraphicNew(Evaluator, this));
            EvalIdens.Add("GRAPHICCLEAR", new IdenGraphicClear(Evaluator, this));
            EvalIdens.Add("GRAPHICCOLOR", new IdenGraphicColor(Evaluator, this));
            EvalIdens.Add("GRAPHICSERIECOLOR", new IdenGraphicSerieColor(Evaluator, this));
