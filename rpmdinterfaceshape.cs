...
namespace Reportman.Designer
{
    internal class DesignerInterfaceShape:DesignerInterfaceSizePos
    {
        ...
        public DesignerInterfaceShape(SortedList<int, ReportItem> repitem)
            : base(repitem)
        {
          if (repitem.Count == 1)
    ...
    internal class DesignerInterfaceImage : DesignerInterfaceSizePos
    {
        ...
        public DesignerInterfaceImage(SortedList<int, ReportItem> repitem)
            : base(repitem)
        {
            if (repitem.Count == 1)
        ...
        public override void GetPropertyValues(string pname, Strings lpossiblevalues)
        {
            ...
            if (pname == Translator.TranslateStr(667))
            {
                lpossiblevalues.Add(Translator.TranslateStr(636)); // Crop
