...
{
    public enum ObjectInspectorCellType { Text, Expression, Integer, Decimal, Boolean, DropDown, DropDownList, Color, Image, FontName, FontStyle };
    ...
    public class ObjectInspectorCell : DataGridViewTextBoxCell
    {
        ...
        {
            return GetColumnValue(columnname, DataGridView.CurrentRow.Index);
        }        
