...
*/			return base.GetHashCode();
	...
	public class Variants
	{
		...
		{
			FCount = 0;
			FItems = new Variant[FIRST_ALLOCATION_OBJECTS];
		}
		public void Clear()
		{
			FCount = 0;
		...
		private void CheckRange(int index)
		{
			if ((index < 0) || (index >= FCount))
				throw new Exception("Index out of range on Variants collection");
		}
		...
		public void Add(Variant obj)
		{
			if (FCount > (FItems.Length - 2))
			{
				Variant[] nobjects = new Variant[FCount];
				System.Array.Copy(FItems, 0, nobjects, 0, FCount);
				FItems = new Variant[FItems.Length * 2];
